...
//    description = "Compiles the FitGAI Android Client."
...
//
//    description = "Compiles and runs the FitGAI in the connected device."
...
//
//        val applicationPackage = "com.hnh.healthapp.${Default.BUILD_FLAVOR}.${Default.BUILD_TYPE}"
//        val launchActivity = "com.hnh.presentation.ui.splash.SplashActivity"
//
