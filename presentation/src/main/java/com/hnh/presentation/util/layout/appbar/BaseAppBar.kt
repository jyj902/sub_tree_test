...
open class BaseAppBar @JvmOverloads constructor(
    ...
    private val textViewTitle = view.findViewById<TextView>(R.id.textview_app_bar_title)
    private val rightTextView = view.findViewById<TextView>(R.id.textview_base_appbar_right_button)
    private val backButton = view.findViewById<ImageButton>(R.id.button_app_bar_back).apply {
        setOnClickListener {
    ...
    private fun setCenterTitleConstraintSet() {
        ConstraintSet().apply {
            clone(container)
            clear(R.id.textview_app_bar_title)
            connect(R.id.textview_app_bar_title, ConstraintSet.TOP, R.id.app_bar_container, ConstraintSet.TOP)
            connect(R.id.textview_app_bar_title, ConstraintSet.BOTTOM, R.id.app_bar_container, ConstraintSet.BOTTOM)
            connect(R.id.textview_app_bar_title, ConstraintSet.START, R.id.app_bar_container, ConstraintSet.START)
            connect(R.id.textview_app_bar_title, ConstraintSet.END, R.id.app_bar_container, ConstraintSet.END)
            applyTo(container)
        }
    ...
    private fun setLeftTitleConstraintSet() {
        ConstraintSet().apply {
            ...
            connect(R.id.textview_app_bar_title, ConstraintSet.TOP, R.id.app_bar_container, ConstraintSet.TOP)
            connect(R.id.textview_app_bar_title, ConstraintSet.BOTTOM, R.id.app_bar_container, ConstraintSet.BOTTOM)
            connect(R.id.textview_app_bar_title, ConstraintSet.START, R.id.app_bar_container_left, ConstraintSet.END)
            connect(R.id.textview_app_bar_title, ConstraintSet.END, R.id.app_bar_container, ConstraintSet.END)
            applyTo(container)
        }
